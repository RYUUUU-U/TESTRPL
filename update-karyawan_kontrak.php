...
<head>
    ...
    <title>WEB KP - <?= isset($_GET['id']) ? 'Edit' : 'Tambah' ?> Kontrak Karyawan</title>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                    <div class="row">
                        <div class="col-sm-12">
                            <h4 class="page-title"><?= isset($_GET['kontrak_id']) ? 'Update' : 'Tambah' ?> Data Karyawan
                                Kontrak
                            </h4>
                        </div>
                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="date" name="tanggal_selesai" id="tanggal_selesai"
                                            class="form-control" value="<?= $tanggal_selesai ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
