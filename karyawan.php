    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="row">
                ...
                <a href="input_user.php" class="btn btn-info btn-rounded float-right" style="margin-left: 10px;">
                    <i class="fa fa-user-plus"></i> Tambah Data User
                </a>
                <a href="Input-Karyawan.php" class="btn btn-primary btn-rounded float-right">
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($ambilsemuadatakaryawan)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $no_hp ?></td>
                                        <td>
                                            <span class="custom-badge status-green"><?= $status_kepegawaian ?> </span>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                                        href="update_karyawan.php?karyawan_id=<?= $kid; ?>">
                                                        <i class="fa fa-pencil m-r-5"></i> Edit
                                                    </a><a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#delete_karyawan<?= $kid; ?>">
                                    ...
                                    <!-- Modal Delete -->
                                    <div id="delete_karyawan<?= $kid; ?>" class="modal fade delete-modal" role="dialog">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <form action="hapus_karyawan.php" method="POST">
                                                <input type="hidden" name="karyawan_id" value="<?= $kid; ?>">
